...
A list of files:
  ...
  3. reactor.py ->   Using Pyomo and its capability to discritize optimization prblem domain automatically, a plug flow reactor is optimized using Ipopt solver of the optimization problem.
